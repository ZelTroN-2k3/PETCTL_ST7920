...
/*
GyverEncoder - une bibliothèque pour le développement d'encodeurs.
Documentation : https://alexgyver.ru/encoder/
Possibilités :
- Pratiquer la rotation de l'encodeur
- Pratique du « virage pressé »
- Pratique du « virage rapide »
- Plusieurs algorithmes d'interrogation d'encodeur
- Sélection du pull-up de connexion du codeur
- Travailler avec deux types d'encodeurs
- Fonctionne avec un encodeur externe (via un extenseur de broches, etc.)
- Bouton appuyé/maintenu avec anti-rebond

Versions:
- 3.6 du 16/09/2019 - Définitions des paramètres renvoyées
- 4.0 du 13/11/2019
- Code optimisé
- Bugs corrigés
- Ajout d'autres algorithmes de sondage
- Ajout de la possibilité de supprimer complètement le bouton (économie de mémoire)
- Ajout de la possibilité de connecter un encodeur externe
- Ajout du réglage de serrage des broches

- 4.1 : Changement fixe des bretelles

- 4.2
- Ajout du support TYPE1 pour l'algorithme PRECISE_ALGORITHM
- Ajout du traitement du double clic : isSingle / isDouble

- 4.3 : Correction du faux isSingle
- 4.4 : Ajout de la méthode resetStates, réinitialise tous les indicateurs et compteurs
- 4.5 : Algorithme BINARY_ALGORITHM amélioré (merci à Yaroslav Kurus)
- 4.6 : BINARY_ALGORITHM corrigé pour TYPE1, ajouté isReleaseHold
- 4.7 : Correction de la rotation aléatoire pressée dans BINARY_ALGORITHM
- 4.8 : Performances améliorées pour AVR Arduino
- 4.9 : Rotation rapide désactivée si le bouton est maintenu enfoncé
*/
// ========= CONSTANTES ==========
